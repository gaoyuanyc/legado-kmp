...
class KtorJvmHttpHandler(private val client: io.ktor.client.HttpClient = HttpClientFactory.create()) : HttpHandler {
...
actual fun createHttpHandler(): HttpHandler = KtorJvmHttpHandler()
